 ...
 * @author Santiago
 */
public class DeleProviders extends javax.swing.JFrame {

    private static userBean uB = new userBean("", "", "", "", "", "", "", "","");
    public int id;

    public DeleProviders(java.awt.Frame parent, boolean modal, providersBean temp) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleProviders.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new DeleProvders().setVisible(true);
            }
        });
    }
    ...
    private void DeletepProviders() throws IOException {
